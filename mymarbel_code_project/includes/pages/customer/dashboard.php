...
<section id="main-content">
	<section class="container" style="text-align: center;">
		...
		<div class="status" style=" width: 100%; margin-top: 120px">
			<p style="text-align: center; color: #00aeef"> The order for your Marbel Board been canceled and your refund has been processed. <br></p>
		</div>
		...
		<table class="video" width="100%">
			<tr>
				<td align="center" valign="top" width="100%">
					<p style=" margin-bottom: 30px; margin-top: -30px; color: #00aeef; font-size: 22px"> Thank you for your deposit, you have secured your spot in line!</p>
					<br/>
					<p style=" margin-bottom: 30px; margin-top: -30px; color: #777; font-size: 18px"> Hold on there! Before you pay your balance <strong>PLEASE</strong> check your order details thoroughly!</p>
					<div class="container">
		...
		<div class= "status" style=" width: 100%; margin-top: 50px">
			...
			<table class="video" width="100%" style="margin-top: 0px">
				<tr>
					<td align="center" valign="top" width="100%">
						<div class="container">
			...
			<h1><strong>Shipping Estimate:</strong> <?php echo $estShipping ?></h1>
		</div>
		<hr>
		<br/>
		<br/>
		<h1 style="border: 1px solid; border-color:#777; width: 400px; height: auto; padding: 10; width: 35; margin-left: auto; margin-right: auto;">Get to know your Marbel Remote </h1>
		<table width="100%" class="video">
			<tbody>
				<tr>
					<td width="50%" align="center" valign="top">
					...
					<td width="50%" align="center" valign="top">
						...
						<p style="padding: 30px;">Made from a combination of fiber reinforced Nylon and ABS, the Marbel Remote has been engineered to be strong and incredibly durable. The anatomical design and smooth matte finish fit comfortably in your hand, providing you an intuitive rider experience that is fun and easy to learn. 
						</p>
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				<tr>
					<td width="50%" align="center" valign="top">
						...
						<p style="padding: 30px;"> Our Safety Switch is a unique feature which ensures the remote only sends throttle data when held in your hand. We also took it a bit further by building in a distinctive tactile "click" into the Safety Switch.  You not only can feel the tactile "click" but also hear it as well. </p>
					</td>
					<td width="50%" align="center" valign="top">
		...
		<div class= "status" style=" width: 100%; margin-top: 40px">
			<p style="text-align: center; color: #00aeef; font-size: 32px ">  
		...
		<hr>
		<h1 style="margin-top: 60px; border: 1px solid; border-color:#777; width: 350px; height: auto; padding: 10; width: 35; margin-left: auto; margin-right: auto;">The Marbel Nose. Knows. </h1>
		<table width="100%" class="video">
			<tbody>
				<tr>
					<td width="50%" align="center" valign="top">
			...
			<tbody>
				<tr>
					<td width="50%" align="center" valign="top">
						...
						<p style="padding: 30px; text-align: left;"> The power button also can function to quick change the riding modes of your Marbel Board.  While your Marbel Board is turned on, simply tap the button twice. This will cycle through four possible options. <br/><br/>
		...
		<table width="100%" class="video">
			<tbody>
				<tr>
					...
					<td width="50%" align="center" valign="top">
						<h1>More to see.</h1>
						<p style="padding: 30px;"> The front bumper of the Marbel Board actually does more than just turning your board on, changing modes, and protecting the board from impacts. Hidden inside the water resistant door, it also houses the charging and USB port. 
						</p>
					</td>
				</tr>
			</tbody>
		...
		<hr>
		<h1 style="margin-top: 60px; border: 1px solid; border-color:#777; width: 350px; height: auto; padding: 10; width: 35; margin-left: auto; margin-right: auto;"> Don't forget the tail... </h1>
		<table width="100%" class="video">
			<tbody>
				<tr>
					<td width="50%" align="center" valign="top">
		...
		<div class= "status" style=" width: 100%; margin-top: 40px; margin-bottom: 40px">
		...
		<div class= "status" style=" width: 100%; margin-top: 40px; margin-bottom: 40px">
			<h1 style="text-align: center; color: #00aeef; font-size: 40px; margin-bottom:-30px">  
				You board is finally shipping!!   <br/> 
			</h1>
			<p style="text-align: center; color: #666666; font-size: 15px; margin-top: 40px">  
				<br/>
		...
		<div class="status" style=" width: 100%; margin-top: 120px">
			<p style="text-align: center; color: #00aeef"> The order for your Marbel Board is on hold. Please contact us to verify your order details. <br></p>
		</div>
		<?php } else { ?>
