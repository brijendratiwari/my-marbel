          ...
          <tbody style="margin-top: -20px">
            ...
            <tr>
              <td width="100%" align="center" valign="top">
                <form id="contactForm" class="cd-form floating-labels" enctype="multipart/form-data" method="POST" action="/ajax/upload">
                  <fieldset>
                    <div class="form-group">
                      <div class="row-fluid">
                        <div class="col-md-12">
                          <textarea placeholder="What's on your mind..." class="form-control" name="cd-notes" id="cd-notes" style="margin-top: -100px" required></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
