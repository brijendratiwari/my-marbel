...
/**
	...
	*/
	...
	function insertUser($email, $first_name, $last_name, $type, $parent_type, $phone, $notes,$email_second,$bio,$height,$weight,$terrain,$company,$address_one,$address_two,$city,$state_region,$postal_code,$country,$accepts_marketing,$alias,$privacy_setting,$units,$rangealarm,$notifications_rides,$primary_riding_style,$safety_brake,$preferred_braking_force,$reverse_turned,$locked_settings,$twitter_handle,$linkedin_handle,$instagram_handle,$reddit_handle, $password, $salt, $db) {
		if ($stmt = $db->prepare("SELECT id FROM m_users WHERE email = ? LIMIT 1")) {
			...
			$stmt->fetch();
			if ($stmt->num_rows == 0) {
				$db->query(sprintf("INSERT INTO m_users (email, first_name, last_name, type, parent_type, register_date, last_activity, phone, notes,email_secondary, bio,height, weight, terrain, company, address_one, address_two, city, state_or_region, postal_code, country, accepts, alias, privacy_setting, units,range_alarm, notifications, primary_riding_style, safety_brake, preferred_braking_force, reverse_turned, locked_settings, twitter_handle, linkedin_handle, instagram_handle, reddit_handle) VALUES ('%s', '%s', '%s', '%s', '%s', UNIX_TIMESTAMP(NOW()), UNIX_TIMESTAMP(NOW()), '%s','%s', '%s','%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');", mysqli_real_escape_string($db, $email), mysqli_real_escape_string($db, $first_name), mysqli_real_escape_string($db, $last_name), $type, $parent_type, mysqli_real_escape_string($db, $phone), mysqli_real_escape_string($db, $notes), mysqli_real_escape_string($db, $email_second), mysqli_real_escape_string($db, $bio),mysqli_real_escape_string($db, $height), mysqli_real_escape_string($db, $weight), mysqli_real_escape_string($db, $terrain), mysqli_real_escape_string($db, $company),mysqli_real_escape_string($db, $address_one),mysqli_real_escape_string($db, $address_two),mysqli_real_escape_string($db, $city),mysqli_real_escape_string($db, $state_region),mysqli_real_escape_string($db, $postal_code),mysqli_real_escape_string($db, $country),mysqli_real_escape_string($db, $accepts_marketing),mysqli_real_escape_string($db, $alias),mysqli_real_escape_string($db, $privacy_setting),mysqli_real_escape_string($db, $units),mysqli_real_escape_string($db, $rangealarm),mysqli_real_escape_string($db, $notifications_rides),mysqli_real_escape_string($db, $primary_riding_style),mysqli_real_escape_string($db, $safety_brake),mysqli_real_escape_string($db, $preferred_braking_force),mysqli_real_escape_string($db, $reverse_turned),mysqli_real_escape_string($db, $locked_settings),mysqli_real_escape_string($db, $twitter_handle),mysqli_real_escape_string($db, $linkedin_handle),mysqli_real_escape_string($db, $instagram_handle),mysqli_real_escape_string($db, $reddit_handle)));
				$stmt->execute();
				$stmt->store_result();
        ...
        function adminUpdateCustomer($user_id, $first_name, $last_name, $type, $parent_type, $email, $phone, $password, $salt, $notes,$email_second,$bio,$weight,$height,$company,$address_one,$address_two,$city,$state_region,$postal_code,$country,$accepts_marketing,$alias,$privacy_setting,$units,$rangealarm,$notifications_rides,$primary_riding_style,$safety_brake,$preferred_braking_force,$reverse_turned,$locked_settings,$terrain,$twitter_handle,$linkedin_handle,$instagram_handle,$reddit_handle, $db) {
		$db->query(sprintf("UPDATE m_users SET email = '%s', first_name = '%s', last_name = '%s', type = '%s', parent_type = '%s', phone = '%s', notes = '%s', email_secondary = '%s' ,bio = '%s' ,height = '%s' ,weight = '%s' ,terrain = '%s' ,company = '%s' ,address_one = '%s' ,address_two = '%s' ,city = '%s' ,state_or_region = '%s' ,postal_code = '%s' ,country = '%s' ,accepts = '%s' ,alias = '%s' ,privacy_setting = '%s' ,units = '%s' ,range_alarm = '%s' ,notifications = '%s' ,primary_riding_style = '%s' ,safety_brake = '%s' ,preferred_braking_force = '%s' ,reverse_turned = '%s',locked_settings = '%s',twitter_handle = '%s',linkedin_handle = '%s',instagram_handle = '%s', 	reddit_handle = '%s' WHERE id = '%s';", mysqli_real_escape_string($db, $email), mysqli_real_escape_string($db, $first_name), mysqli_real_escape_string($db, $last_name), $type,$parent_type, mysqli_real_escape_string($db, $phone), mysqli_real_escape_string($db, $notes),mysqli_real_escape_string($db, $email_second), mysqli_real_escape_string($db, $bio),mysqli_real_escape_string($db, $height),mysqli_real_escape_string($db, $weight),mysqli_real_escape_string($db, $terrain),mysqli_real_escape_string($db, $company),mysqli_real_escape_string($db, $address_one),mysqli_real_escape_string($db, $address_two),mysqli_real_escape_string($db, $city),mysqli_real_escape_string($db, $state_region),mysqli_real_escape_string($db, $postal_code),mysqli_real_escape_string($db, $country),mysqli_real_escape_string($db, $accepts_marketing),mysqli_real_escape_string($db, $alias),mysqli_real_escape_string($db, $privacy_setting),mysqli_real_escape_string($db, $units),mysqli_real_escape_string($db, $rangealarm),mysqli_real_escape_string($db, $notifications_rides),mysqli_real_escape_string($db, $primary_riding_style),mysqli_real_escape_string($db, $safety_brake),mysqli_real_escape_string($db, $preferred_braking_force),mysqli_real_escape_string($db, $reverse_turned),mysqli_real_escape_string($db, $locked_settings),mysqli_real_escape_string($db, $twitter_handle),mysqli_real_escape_string($db, $linkedin_handle),mysqli_real_escape_string($db, $instagram_handle),mysqli_real_escape_string($db, $reddit_handle),$user_id));
	...
	function getCustomer($id, $db) {
		...
		$customer = array();
		if ($stmt = $db->prepare("SELECT mu.id, mu.email, mu.first_name, mu.last_name, mu.type, mu.parent_type, mu.register_date, mu.last_activity, mu.phone, mu.notes, muli.ip,mu.email_secondary,mu.bio,mu.height,mu.weight,mu.terrain,mu.company,mu.address_one,mu.address_two,mu.city,mu.state_or_region,mu.postal_code,mu.country,mu.accepts,mu.alias,mu.privacy_setting,mu.units,mu.range_alarm,mu.notifications,mu.primary_riding_style,mu.safety_brake,mu.preferred_braking_force,mu.reverse_turned,mu.locked_settings,mu.user_profile_pic,mu.reddit_handle,mu.instagram_handle,mu.linkedin_handle,mu.twitter_handle  FROM m_users mu LEFT JOIN m_user_login_ip muli ON muli.user_id = mu.id AND muli.time = mu.last_activity WHERE mu.id = ? ORDER BY mu.id ASC;")) {
			$stmt->bind_param('i', $id);
			$stmt->execute();
			$stmt->store_result();	 
			$stmt->bind_result($user_id,$email,$first_name,$last_name,$type,$type_parent,$register_date,$last_activity,$phone,$notes,$last_ip,$email_secondary,$bio,$height,$weight,$terrain,$company,$address_one,$address_two,$city,$state_or_region,$postal_code,$country,$accepts,$alias,$privacy_setting,$units,$range_alarm,$notifications,$primary_riding_style,$safety_brake,$preferred_braking_force,$reverse_turned,$locked_settings,$user_profile_pic,$twitter_handle,$linkedin_handle,$instagram_handle,$reddit_handle);
