...
$route['get_customer_info_new/(:num)'] = 'admin/customers/get_customer_info_new/$1';
...
$route['update_task']='admin/tasks/update_task';
...
$route['ride_details']='admin/customersrides/ride_details';
