            ...
            <div class="col-md-12" style="background-color: #fafafa; color: #666;padding-bottom: 20px;">
                <form class="cd-form floating-labels" style="max-width: 100%; width: 100%;margin: 0px;" method="POST" action="">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3 form-group">Service Type: 
                            <p class="cd-select">
                                <select class="cd-type form-control" name="cd-type" id="cd-type">
                                    <option <?php
                                    if (strcmp($service['type'], 'warrenty') == 0) {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="warrenty">Warrenty</option>
                                    <option <?php
                                    if (strcmp($service['type'], 'service') == 0) {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="service">Service</option>
                                    <option <?php
                                    if (strcmp($service['type'], 'refund') == 0) {
                                        echo 'selected="selected"';
                                    }
                        ...
                        <div class="col-md-3 form-group">Service Status:
                            <p class="cd-select"> 
                                <select class="cd-status form-control" name="cd-status" id="cd-status">
                                    <option <?php
                                    if (strcmp($service['status'], 'pending') == 0) {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="pending">Pending</option>
                                    <option <?php
                                    if (strcmp($service['status'], 'inhouse') == 0) {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="inhouse">In House</option>
                                    <option <?php
                                    if (strcmp($service['status'], 'onhold') == 0) {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="onhold">On Hold</option>
                                    <option <?php
                                        if (strcmp($service['status'], 'finished') == 0) {
                                            echo 'selected="selected"';
                                        }
                                        ?> value="finished">Finished</option>
                                    <option <?php
                                    if (strcmp($service['status'], 'shipped') == 0) {
                                        echo 'selected="selected"';
                                    }
                        ...
                        <div class="col-md-3 form-group">Due: <p><input type="text" name="cd-due" id="cd-due" class="form-control" style="padding:9px" value="<?php
                                                                    if ($service['due_date'] > 0) {
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 form-group">
                            <p><textarea class="issue form-control" name="cd-issue" id="cd-issue" placeholder="Reported Issues" maxlength="12"><?php echo $service['issue']; ?></textarea></p>
                        </div>
                        <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4 form-group">
                                    <span>Board: <input type="checkbox" name="included_parts[]" value="board" <?php
                                                        if (in_array('board', $service['included_parts'])) {
                                                            echo "checked=\"true\"";
                                                        }
                                                        ?>/></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <span>Remote: <input type="checkbox" name="included_parts[]" value="remote" <?php
                                                        if (in_array('remote', $service['included_parts'])) {
                                                            echo "checked=\"true\"";
                                                        }
                                                        ?>/></span>
                                </div>
                                <div class="col-md-4 form-group">
                                    <span>Charger: <input type="checkbox" name="included_parts[]" value="charger" <?php
                                                if (in_array('charger', $service['included_parts'])) {
                                                    echo "checked=\"true\"";
                                                }
                                                ?>/></span>
                                </div>
                            ...
                            <div class="col-md-12 form-group">
                                <div class="col-md-4">
                                    <span>Manual: <input type="checkbox" name="included_parts[]" value="manual" <?php
                                        if (in_array('manual', $service['included_parts'])) {
                                            echo "checked=\"true\"";
                                        }
                                        ?>/></span>
                                </div>
                                <div class="col-md-4">
                                    <span>Tool: <input type="checkbox" name="included_parts[]" value="tool" <?php
                                        if (in_array('tool', $service['included_parts'])) {
                                            echo "checked=\"true\"";
                                        }
                                        ?>/></span>
                                </div>
                                <div class="col-md-4">
                                    <span>Other: <input type="checkbox" name="included_parts[]" value="other" <?php
                                                    if (in_array('other', $service['included_parts'])) {
                                                        echo "checked=\"true\"";
                                                    }
                                                    ?>/></span>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <select name="included_parts[]" class="form-control">
                                        <option value="black" <?php
                                                    if (in_array('black', $service['included_parts'])) {
                                                        echo "selected=\"true\"";
                                                    }
                                                    ?>>Wheel Color: Black</option>
                                        <option value="blue" <?php
                            if (in_array('blue', $service['included_parts'])) {
                                echo "selected=\"true\"";
                            }
                            ?>>Wheel Color: Blue</option>
                                ...
                                <div class="col-md-6">
                                    <select name="included_parts[]" class="form-control">
                                        <option value="76" <?php
                        if (in_array('76', $service['included_parts'])) {
                            echo "selected=\"true\"";
                        }
                        ?>>Wheel Size: 76mm</option>
                                        <option value="100" <?php
                        if (in_array('100', $service['included_parts'])) {
                            echo "selected=\"true\"";
                        }
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <span>Test Ride: <input type="checkbox" name="test_ride" <?php
                        if ($service['test_ride_complete'] == 1) {
                            echo "checked=\"true\"";
                        }
                        ?>> <?php
                        if ($service['test_ride_complete'] == 1) {
            ...
            ?>
                ...
                ?>
                    ...
                    <div class="row-fluid">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <span>Final Test Ride: <input type="checkbox" name="final_test_ride" <?php
                            if ($service['final_test_ride_complete'] == 1) {
                                echo "checked=\"true\"";
                            }
                            ?>> <?php
                            if ($service['final_test_ride_complete'] == 1) {
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 form-group">
                            <span>Quality Control Check: <input type="checkbox" name="qa_complete" <?php
                            if ($service['qa_complete'] == 1) {
                                echo "checked=\"true\"";
                            }
                            ?>f> <?php
                            if ($service['qa_complete'] == 1) {
