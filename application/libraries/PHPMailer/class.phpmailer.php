...
class PHPMailer
{
     ...
     * @type integer
     */
    public $Priority = null; // JOHNMOD Was 3. Fixes XPRIO spamassassin score problem. 
    ...
    public function createHeader()
    {
		...
		if(!is_null($this->Priority)) {
			  $result .= $this->headerLine('X-Priority', $this->Priority); // JOHNMOD Fixes XPRIO spamassassin score problem. 
		}
        if ($this->XMailer == '') {
