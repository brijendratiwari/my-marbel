...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDpxWYBswlHcEM9w4BxWKLPA_J-u2cfvfM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function add_polyline($params = array())
	{
		...
		$polyline['strokeColor'] = '#00aeef';					// The hex value of the polylines color
		$polyline['strokeOpacity'] = '1.0';						// The opacity of the polyline. 0 to 1.0
		$polyline['strokeWeight'] = '8';						// The thickness of the polyline
