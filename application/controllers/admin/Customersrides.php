...
class CustomersRides extends CI_Controller {
    ...
    public function rides_list() {
        ...
        $col_sort = array("m_rides.ride_ID", "m_rides.ride_ID", "m_users.first_name", "m_users.last_name", "m_rides.start_time", "m_rides.trip_distance", "m_rides.ride_maxspeed", "m_rides.ride_avgspeed", "m_rides.trip_duration", "m_rides.efficiency");
        ...
        $this->Rides->db->select("m_rides.ride_ID,m_users.first_name,m_users.last_name,m_rides.start_time,round(m_rides.trip_distance,2) as trip_distance,m_rides.ride_maxspeed,m_rides.ride_avgspeed,round((m_rides.trip_duration/60),2) AS trip_duration,round(m_rides.efficiency,2) as efficiency");
        ...
        $this->db->select('m_rides.ride_ID,m_users.first_name,m_users.last_name,m_rides.start_time,round(m_rides.trip_distance,2) as trip_distance,m_rides.ride_maxspeed,m_rides.ride_avgspeed, round((m_rides.trip_duration/60),2) AS trip_duration,round(m_rides.efficiency,2) as efficiency');
